...
export default function WeeklyReport() {
  ...
  const generate = async () => {
    ...
    setLoading(true);
    try {
      const data = await appClient.reports.generateWeeklyReport(projectId);
      setReport(data);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Weekly Report" subtitle="Generate weekly progress reports" icon={FileText} />
