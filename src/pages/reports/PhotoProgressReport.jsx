...
export default function PhotoProgressReport() {
  ...
  const generate = async () => {
    ...
    setLoading(true);
    try {
      const data = await appClient.reports.generatePhotoProgressReport(projectId);
      setReport(data);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Photo Progress Report" subtitle="Generate photo documentation reports" icon={Camera} />
