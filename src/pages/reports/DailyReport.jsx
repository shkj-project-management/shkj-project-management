...
export default function DailyReport() {
  ...
  const generate = async () => {
    ...
    setLoading(true);
    try {
      const data = await appClient.reports.generateDailyReport(projectId, reportDate);
      setReport(data);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Daily Report" subtitle="Generate daily progress reports" icon={FileText} />
