...
export default function VendorReport() {
  ...
  const generate = async () => {
    ...
    setLoading(true);
    try {
      const data = await appClient.reports.generateVendorReport(projectId);
      setReport(data);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Vendor Report" subtitle="Generate vendor performance reports" icon={Truck} />
