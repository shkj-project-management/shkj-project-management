...
export default function IPCNReport() {
  ...
  const generate = async () => {
    ...
    setLoading(true);
    try {
      const data = await appClient.reports.generateIPCNReport(projectId);
      setReport(data);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="IPCN Report" subtitle="Generate infection prevention and control reports" icon={Shield} />
