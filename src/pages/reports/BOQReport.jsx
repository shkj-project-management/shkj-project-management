...
export default function BOQReport() {
  ...
  const generate = async () => {
    ...
    setLoading(true);
    try {
      const data = await appClient.reports.generateBOQReport(projectId);
      setReport(data);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="BOQ Report" subtitle="Generate Bill of Quantities reports" icon={Calculator} />
