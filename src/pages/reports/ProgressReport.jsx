...
export default function ProgressReport() {
  ...
  const generate = async () => {
    ...
    setLoading(true);
    try {
      const data = await appClient.reports.generateProgressReport(projectId);
      setReport(data);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Progress Report" subtitle="Generate physical and financial progress reports" icon={TrendingUp} />
