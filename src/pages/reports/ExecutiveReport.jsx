...
export default function ExecutiveReport() {
  ...
  const generate = async () => {
    ...
    setLoading(true);
    try {
      const data = await appClient.reports.generateExecutiveReport(projectId);
      setReport(data);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Executive Report" subtitle="Generate executive summary reports" icon={Presentation} />
