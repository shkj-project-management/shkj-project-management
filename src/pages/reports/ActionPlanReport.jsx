...
export default function ActionPlanReport() {
  ...
  const generate = async () => {
    ...
    setLoading(true);
    try {
      const data = await appClient.reports.generateActionPlanReport(projectId);
      setReport(data);
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Action Plan Report" subtitle="Generate action plan status reports" icon={CheckSquare} />
